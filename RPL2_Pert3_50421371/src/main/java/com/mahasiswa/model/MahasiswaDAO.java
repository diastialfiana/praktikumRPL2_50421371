...
public class MahasiswaDAO {
    ...
    public MahasiswaDAO(){
        try {
            ...
            connection.setAutoCommit(true); // Tambahkan ini jika perlu
        } catch(Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void addMahasiswa(ModelMahasiswa mahasiswa) {
        ...
        try {
            ...
            pstmt.executeUpdate();
            System.out.println("Mahasiswa ditambahkan: " + mahasiswa.getNpm() + ", " + mahasiswa.getNama());
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
        ...
        try {
            ...
            while(rs.next()){
                mahasiswaList.add(new ModelMahasiswa(
                        ...
                        rs.getString("nama"),
                        rs.getInt("semester"),
                        rs.getFloat("ipk") // Nama kolom disesuaikan
                ));
            }
        } catch (SQLException e) {
            e.printStackTrace();
