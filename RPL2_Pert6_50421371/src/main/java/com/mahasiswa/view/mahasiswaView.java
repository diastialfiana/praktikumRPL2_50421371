    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (result == JOptionPane.OK_OPTION) {
            try {
                ...
                if (idText.isEmpty()) {
                    throw new NumberFormatException("ID tidak boleh kosong.");
                }
                ...
                loadMahasiswaTable(); // Refresh the table after deletion
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(this, "ID harus berupa angka yang valid.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
